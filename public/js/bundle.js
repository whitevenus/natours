...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiZHJ5c2QwaGluMiIsImEiOiJjbHIwZTZ3bnIwaHpiMnB0YWMzNzRrZDEyIn0.YEDMJ_sakIGPen2K1nMFHw";
  var map = new mapboxgl.Map({
    container: "map",
    // container ID
    style: "mapbox://styles/drysd0hin2/clr0iq06d008e01p52tkcfmql",
    // style URL
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === "success") {
            alert("".concat(type.toUpperCase(), " \u66F4\u65B0\u6210\u529F\uFF5E"));
          }
          _context.next = 11;
          break;
        case 8:
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe("pk_test_51OVYEgCeCfpzbJfXpmjKr9VgFJTr2p4SPUdDabrWSYI9spQuphiWi8Hh5S9Aofs7tHHIJNT6C7xcXsgEAGe84bRj00bYtYT7B5");
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          document.querySelector(".btn--save--password").textContent = "正在更新...";
          // VALUES
        ...
        case 7:
          document.querySelector(".btn--save--password").textContent = "保存密码";
